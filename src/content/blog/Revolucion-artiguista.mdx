...
<div className="flex flex-col items-center text-center">
  <img className="mx-auto" src="https://raw.githubusercontent.com/alexcuadroo/eduhistoria/refs/heads/main/public/sources/grito_de_asencio.jpg" alt="Grito de Asencio" />
  <p className="italic">Grito de Asencio</p>
</div>
